      ...
      <el-form :model="form" :rules="rules" ref="form">
       ...
       <!--t1-->
        ...
        <el-form-item label="内容" :label-width="formLabelWidth" prop="content">
          ...
          <!-- <build> -->
            <mdEditor  @changeValue="contentChange" :content="form.content"  ref="ckeditor"></mdEditor>
        </el-form-item>
      </el-form>
...
<script>
import { getBlogList, getBlogContent,  addBlog, uploadLocalBlog, editBlog, deleteBlog, deleteBatchBlog } from "@/api/blog";
...
import mdEditor from '../../components/MarkdownEditor/editor.vue'
...
export default {
  ...
  methods: {
    ...
    handleEdit: function(row) {
      ...
      this.title = "编辑博客";
      this.form = row;
      this.form.blogSortUid=row.blogSort.uid;
      var that = this;

        //获取博客内容
        var param={};
        param.uid=BlogUid;
        getBlogContent(param).then(res=>{
         // console.log(res.data);
          this.$refs.ckeditor.initText(res.data);
