  ...
  <div class="app-container">
    ...
    <el-table :data="tableData" style="width: 100%">
      ...
      <el-table-column align="center" label="头像" width="120">
        <template slot-scope="scope">
          <img
            :src="scope.row.avatar ? scope.row.avatar:'https://wpimg.wallstcn.com/f778738c-e4f8-4870-b634-56703b4acafe.gif'" onerror="onerror=null;src='https://wpimg.wallstcn.com/f778738c-e4f8-4870-b634-56703b4acafe.gif'"
      ...
      <el-form :model="form" :rules="rules" ref="form">
        <el-form-item :label-width="formLabelWidth" label="用户头像">
          <div class="imgBody" v-if="form.avatar">
            ...
            <img @mouseout="icon = false" @mouseover="icon = true" v-bind:src="form.avatar"/>
          </div>
