      ...
      <el-tab-pane label="个人履历" name="third">
        ...
        <div class="editor-container">
          <!-- <CKEditor ref="ckeditor" :content="form.personResume" :height="500"></CKEditor> -->
           ...
           <mdEditor  @changeValue="contentChange" :content="form.personResume"  ref="ckeditor"></mdEditor>
        </div>
    ...
    getMeInfo: function() {
      ...
      getMe(getMeParams).then(response => {
        ...
        if (response.code == "success") {
          ...
          this.$refs.ckeditor.initText(response.data.personResume)
        }
      });
    },
