...
import com.moxi.hyblog.picture.vo.NetworkDiskVO;
import com.moxi.hyblog.picture.entity.NetworkDisk;
import com.moxi.hyblog.picture.entity.Storage;
import com.moxi.hyblog.picture.global.MessageConf;
import com.moxi.hyblog.picture.global.SysConf;
import com.moxi.hyblog.picture.service.FileService;
import com.moxi.hyblog.picture.service.NetworkDiskService;
import com.moxi.hyblog.picture.service.StorageService;
import com.moxi.hyblog.picture.util.FeignUtil;
import com.moxi.hyblog.picture.util.QiniuUtil;
import com.moxi.hyblog.utils.FileUtils;
import com.moxi.hyblog.utils.RestResult;
import com.moxi.hyblog.utils.WebUtils;
import com.moxi.hyblog.utils.upload.FileOperation;
import com.moxi.hyblog.utils.upload.ImageOperation;
import com.moxi.hyblog.utils.upload.PathUtil;
...
//        }
    ...
    public String uploadFile(HttpServletRequest request, NetworkDisk networkDisk) {
        ...
        List<com.moxi.hyblog.picture.entity.File> fileList = WebUtils.getAllList(result, com.moxi.hyblog.picture.entity.File.class);
        // 写入NetworkDisk表中
