...
public class WebUtils {
    ...
    public static <T> T getData(String result, Class<T> beanType) {
        if (com.moxi.hyblog.utils.StringUtils.isEmpty(result)) {
            return null;
        }
     ...
     * 将实体类转化成map
     */
    public static <T> Map<String,Object> changeToMap(T data){
    ...
    public static String getCode(String result){
        return ((Map<String, Object>) JsonUtils.jsonToObject(result,Map.class)).get("code").toString();
    }
