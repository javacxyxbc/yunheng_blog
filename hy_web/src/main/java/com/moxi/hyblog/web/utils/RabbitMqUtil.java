package com.moxi.hyblog.web.utils;
...
public class RabbitMqUtil {
    ...
    public void sendCommentAll(){
        ...
        result.put(SysConf.COMMAND,SysConf.COLLECT);
        rabbitTemplate.convertAndSend(EXCHANGE_DIRECT,SysConf.ROUTING_KEY_COLLECT,result);
    }
    /**
     * 发送博客点赞,点击增加指令
     */
    public void sendCommentCollect(String uid, String type){
        Map<String, Object> result = new HashMap<>();
        result.put(SysConf.COMMAND,type);
        result.put(SysConf.UID,uid);
        rabbitTemplate.convertAndSend(EXCHANGE_DIRECT,SysConf.ROUTING_KEY_COLLECT,result);
    }
