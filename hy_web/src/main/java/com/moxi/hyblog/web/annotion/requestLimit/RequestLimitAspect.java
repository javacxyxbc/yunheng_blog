package com.moxi.hyblog.web.annotion.requestLimit;

import com.moxi.hyblog.base.global.ECode;
import com.moxi.hyblog.utils.AspectUtil;
...
public class RequestLimitAspect {
    ...
    private final String POINT = "execution(* com.moxi.hyblog.web.restapi..*.*(..))";
    @Autowired
