package com.moxi.hyblog.commons.config.jwt;

import com.moxi.hyblog.commons.config.security.SecurityUser;
...
public class JwtHelper {
    ...
    public Boolean validateToken(String token, UserDetails userDetails, String base64Security) {
        SecurityUser SecurityUser = (com.moxi.hyblog.commons.config.security.SecurityUser) userDetails;
