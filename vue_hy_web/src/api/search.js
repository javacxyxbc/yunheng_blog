...
//   return request({
//     url: process.env.Search_API + '/search/sqlSearchBlog',
//     method: 'get',
//     params
//   })
// }
...
export function searchBlogByTag (params) {
  return request({
    url: process.env.Search_API + '/search/searchBlogByTag',
    method: 'get',
    params
  })
}
...
export function searchBlogBySort (params) {
  return request({
    url: process.env.Search_API + '/search/searchBlogBySort',
    method: 'get',
    params
  })
}
...
export function searchBlogByAuthor (params) {
  return request({
    url: process.env.Search_API + '/search/searchBlogByAuthor',
    method: 'get',
    params
  })
}
