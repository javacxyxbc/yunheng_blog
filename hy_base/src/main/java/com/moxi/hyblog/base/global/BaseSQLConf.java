package com.moxi.hyblog.base.global;
...
public class BaseSQLConf {
    ...
    public final static String CLICK_CNT="clickCount";
    public final static String PRISE_CNT="priseCount";
    public final static String CLICK_COUNT="click_count";
    public final static String PRISE_COUNT="prise_count";
    ...
    public final static String TABLE_T1_UID="t1.uid";
    public final static String TABLE_T1_STATUS="t1.status";
    public final static String TABLE_T1_PUBLIST="t1.is_publish";
    public final static String TABLE_T1_SORT="t1.sort";
    /**
     * 字典表相关
     */
